...
async def create_indexes(db: AsyncIOMotorDatabase) -> None:
    ...
    try:
        ...
        await db.barber_schedules.create_index([("barber_id", ASCENDING), ("date", ASCENDING)])
        ...
        await db.appointments.create_index([("barber_id", ASCENDING), ("appointment_date", DESCENDING)])
